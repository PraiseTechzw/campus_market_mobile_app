...
class AddRoomStep3ImagesScreen extends HookConsumerWidget {
  const AddRoomStep3ImagesScreen({super.key});

  Future<String> _uploadImage(File file, void Function(double) onProgress) async {
    final ref = FirebaseStorage.instance.ref('room_images/${DateTime.now().millisecondsSinceEpoch}_${file.path.split('/').last}');
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Text('Step 3 of 4', style: TextStyle(color: primaryColor, fontWeight: FontWeight.bold)),
              ...
              const Text('Add 3–5 images', style: TextStyle(fontWeight: FontWeight.bold)),
                  ...
                  Expanded(
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: images.value.length >= 3 ? primaryColor : Colors.grey[800],
                        foregroundColor: Colors.white,
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(32)),
                        padding: const EdgeInsets.symmetric(vertical: 16),
                      ),
                      onPressed: images.value.length >= 3 && !isLoading.value ? () {
